...
(function () {
  ...
  ready(function init(){
    ...
    wireHud(why,  "SOMETIMES WE DRIFT OFF-CENTER. THIS IS NOT FAILURE BUT SIGNAL. THE FIELD IS A REALITY-CHECK, SO WE REMEMBER WHAT IS REAL.");
    wireHud(how,  "WE MOVE THROUGH ONE OF A HUNDRED EXPLORATIONS EACH WEEK. THE ORACLE OFFERS DAILY SIGNAL. BREATHING IN FOUR-SECOND CYCLES RE-CALIBRATES. JOURNAL WHEN YOU DESIRE UNITY.");
    wireHud(what, "THIS IS A MINIMAL INSTRUMENT FOR ATTENTION. A TUNING DEVICE TO REALIGN YOU TO CENTER THROUGH COMMITMENT AND DEVOTION TO YOUR SELF-AVATAR. THE PRACTICE IS SOVEREIGNTY, REDEMPTION, SELF-RELIANCE.");
    ...
    if(isTouch){
      ...
      sticky(why,  "SOMETIMES WE DRIFT OFF-CENTER. THIS IS NOT FAILURE BUT SIGNAL. THE FIELD IS A REALITY-CHECK, SO WE REMEMBER WHAT IS REAL.");
      sticky(how,  "WE MOVE THROUGH ONE OF A HUNDRED EXPLORATIONS EACH WEEK. THE ORACLE OFFERS DAILY SIGNAL. BREATHING IN FOUR-SECOND CYCLES RE-CALIBRATES. JOURNAL WHEN YOU DESIRE UNITY.");
      sticky(what, "THIS IS A MINIMAL INSTRUMENT FOR ATTENTION. A TUNING DEVICE TO REALIGN YOU TO CENTER THROUGH COMMITMENT AND DEVOTION TO YOUR SELF-AVATAR. THE PRACTICE IS SOVEREIGNTY, REDEMPTION, SELF-RELIANCE.");
