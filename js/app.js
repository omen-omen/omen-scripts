...
(function () {
  ...
  ready(function init(){
    ...
    const BUTTONDOWN_USERNAME = "OMEN"; // your Buttondown list username
    ...
    function ensureDevicesOverlay(){
      ...
      // Start hidden so it never blocks the page until opened
      ...
      // Close when clicking outside the form/titles
    ...
    /* Global ESC to close everything */
