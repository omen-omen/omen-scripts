...
(function () {
  ...
  ready(function init(){
    ...
    wireHud(why,  "SOMETIMES WE DRIFT OFF-CENTER. THIS IS A REALITY-CHECK. SO WE CAN REMEMBER WHAT’S REAL.");
    wireHud(how,  "WE DRIFT ON ONE OF HUNDERED EXPLORATIONS EACH WEEK. YOU CAN ALWAYS ASK THE ORACLE FOR DAILY GUIDANCE. BREATHING IS ON FOUR SECONDS INTERVAL. JOURNAL WHENEVER YOU TRULY DESIRE UNITY.");
    wireHud(what, "THIS IS A MINIMAL INSTRUMENT FOR ATTENTION. IT'S DESIGNED TO REALIGN YOU TO YOUR CENTER THROUGH COMMITMENT AND DEVOTION TO YOUR SELF/AVATAR. SELF-RELIANCE, REDEMPTION, AND SOVEREIGNTY.");
